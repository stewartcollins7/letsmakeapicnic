...
class DistanceCalculator {
    companion object {
         ...
         */
        public fun getBestTwoShopIndexes(startPoint: LatLng, destination: LatLng, shopsType1Result: PlaceDataResult, shopsType2Result: PlaceDataResult): Pair<Int,Int>{
        ...
        public fun getBestShopIndex(result: PlaceDataResult, currentLocation: LatLng, destination: LatLng): Int{
        ...
        private fun createSortedSequenceFromDistances(doubleArray: DoubleArray): List<Pair<Double,Int>>{
            ...
            var indexedPairs = doubleArray.zip(indexes)
            var sortedPairs = indexedPairs.sortedBy { (distance,index) -> distance }
            return sortedPairs
        }

        private fun calculateDistancesForEachPlace(currentLocation: LatLng, destination: LatLng, places: ArrayList<LatLng>): DoubleArray{
            var distances = DoubleArray(places.size)
